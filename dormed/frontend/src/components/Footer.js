...
function Footer() {
    ...
    <ul className="nav col-md-4 justify-content-end pe-5 list-unstyled d-flex">
      <li className="ms-3 pulse"><a href="#"><Instagram  size={24} /></a></li>
      <li className="ms-3 pulse"><a href="#"><Twitter  size={24} /></a></li>
      <li className="ms-3 pulse"><a href="#"><Facebook  size={24} /></a></li>
    </ul>
  </footer>
